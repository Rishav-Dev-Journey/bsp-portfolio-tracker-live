  ...
  useEffect(() => {
    ...
    holdings.forEach((holding) => {
      ...
      if (
        ...
        previousPrice !== holding.currentPrice
      ) {
        nextFlashMap[holding.ticker] =
          holding.currentPrice > previousPrice ? "up" : "down";
      }
              ...
              holdings.map((holding) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className={`px-5 py-5 text-sm font-semibold sm:px-6 ${isPositive ? "text-emerald-300" : "text-rose-300"}`}
                    >
